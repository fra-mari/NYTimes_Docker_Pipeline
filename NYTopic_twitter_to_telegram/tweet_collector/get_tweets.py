...
def cursor_cycle():
    ...
    for status in cursor.items(10):
        ...
        # take extended tweets into account and rules out retweets
...
# we connect to the container that has mongo on it
client = pymongo.MongoClient("mongodb")
db = client.tweet_collector  # and we create a database on mongo called "tweet_collector"

# and we create a collection called "tweet_data"
...
for cycle in range(2):#10800):           
    cursor_cycle()
    sleep(2)

#Starting the live-stream after initial loading
while True:
    api, auth = authentication_attempt()
